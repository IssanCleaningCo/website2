...
export default async function handler(req, res) {
  ...
  const html = `
    <div style="font-family:Inter,sans-serif;max-width:600px;margin:auto;">
      <h2 style="color:#222;">Estimate from Issan Cleaning Co.</h2>
      <p><strong>Estimate #:</strong> ${estimateNumber}<br>
      ...
      <hr>
      <p style="font-size:13px;color:#888;">Thank you for considering Issan Cleaning Co.!<br>issancleaningco@gmail.com | (305) 701-3909</p>
    </div>
  `;
  ...
  try {
    ...
    return res.status(200).json({ message: 'Estimate email sent!' });
  } catch (err) {
